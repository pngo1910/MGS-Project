<?php
  ...
  //set cookies
  //setcookie("login_email", "contact@mbgenealogy.com", time() - 3600, "/", ".paypal.com", 1);
?>
    ...
    <div id="resultsbackground">
      <div id="container" class="home">
        ...
        <ul id="livedash">
          ...
          <li><a href='../live/searchTransactions.php'>Search Transactions</a></li>
          <li><a href='../live/searchPurchases.php'>Search Store Purchases</a></li>
          <li><a href='../live/searchResearch.php'>Search Research</a></li>
          <li><a href='https://www.paypal.com/businessexp/summary'>View Paypal Account</a></li>
        </ul>
      </div>
    </div>
  </body>
