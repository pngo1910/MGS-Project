<?php
	...
	if(isset($_POST['update']) && isset($_POST['checked']))
	{
        ...
        $stmt = sqlsrv_query( $storeConn, $sql, array($_POST['purchaseID']), array( "Scrollable" => 'static' ));

        if ($stmt === false) errorReport(sqlsrv_errors(), __FILE__, __LINE__);
	}
	else if(strpos($_SERVER['HTTP_REFERER'], 'searchPurchases.php') !== false)
	{
		$_SESSION['post'] = $_POST;
	}
    	...
    	<script type="text/javascript">
		    ...
		    $(document).ready(function() {
		        ...
		        var oTable = $('#example').dataTable( {
		            ...
		            "bInput" : true,
		            "aoColumns": j_cols,
		            "sAjaxSource": "purchasesQuery.php",	
		            "oLanguage": {
	...
	<body>
		<div id="resultsbackground">
	    	<div id="container" class="home">
				...
				<form action="purchasesExport.php" method="POST">
