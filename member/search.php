        ...
        <div id="container" class="home">
          <div id="searchresults">
            ...
            <?php require('balanceWidget.php'); ?>
             <div id="introtext">
              <h1>MANI Search</h1>
               <p>MANI will allow you to search the indexes of the MGS. You will be able to:
              </p>
              <ul>
                <li>Locate individuals that match your search criteria</li>
                <li>Discover the resource that was indexed and information on how to access further information</li>
                <li>In a later phase you will be able to purchase copies of the page or the complete MGS publication where the information exists</li>
              </ul>
              <p>
