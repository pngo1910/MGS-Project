        ...
        <!--<div id="homebackground"></div> -->       
            <div id="container" class="home">
                ...
                <div id="searchresults">
                    ...
                    <p><b>**Note:</b>To finalize the purchase,click the Paypal button at the bottom of the page</p>
                    <p><a href="store.php?name=<?= $name ?>"><input type="button" value="Return to Store"></input></a></p>
                    ...
                    <?php if(!empty($_SESSION['values'])): ?>
                        ...
                        <dl>
                            ...
                            <dd><b>Shipping:</b> $<?= (float)$newarray[$i]?></dd>
                            <?php $totalShipping += (float)$newarray[$i] * $quantities[$index]?>
                        ...
                        <?php $total += $totalShipping > 20 ? 20 : $totalShipping?>
                        ...
                        <form action="createPayPalCart.php?name=<?= $name ?>" method="post" onsubmit="return purchaseProducts()">
                            ...
                            <input type="email" id="email" name="email" required="true" value="<?=$email;?>" <?=$disabled;?> /> *
                            <br/><br/>
