...
<header>
  <?php if ($_SESSION['verified']) : ?>
       <a id="logo-link" href="/member/" style="padding:0px;margin:0px">
   <?php else :?>
  ...
  <div class="navDash">
    <ul>
      ...
      <?php if (session_name() === 'login') : ?>
        <ul>
          <?php if ($_SESSION['verified']) : ?>
            <li><a href="/member/search.php" class="head-link">Search</a></li>
            <?php if ($_SESSION['access'] >= 1) : ?>
              <li><a href="/store/index.php?name=login" class="head-link">Store</a></li>
            <?php endif ?>
            <?php if ($_SESSION['access'] >= 1) : ?>
              <li><a href="/Research/index.php?name=login" class="head-link">Research</a></li>
            <?php endif ?>
            ...
            <?php endif ?>
            <?php if ($_SESSION['access'] >= 3 || $_SESSION['eStore'] == 1) : ?>
              <li><a href="/admin/store/" class="head-link">Store Management</a></li>
            <?php endif ?>
            ...
            <?php endif ?>
            <?php if ($_SESSION['SpecialProject'] == 1) : ?>
              <li><a href="/SpecialProject/" class="head-link">Special Project</a></li>
            <?php endif ?>
