  ...
  <body>
    <div id="resultsbackground">
      <div id="container" class="home">
        ...
        <?php else : ?>
          <p><b>Clicking Register will send you to PayPal. If you have a PayPal account you'll have the opportunity to log in. If you don't have a PayPal account you'll have the option to create a PayPal account. You can also just enter your credit card information without creating a PayPal account.</b></p>
