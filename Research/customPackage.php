...
<html lang="en-US">
	...
	<body>
		...
		<div class="content">
			<h1>MGS Custom Research Package</h1> <p>
				<strong> Directions: </strong> Complete this form and finalize the process by clicking on the "Checkout" button at the bottom of the form. You will be presented with a page containing the details of your order so that you can confirm what you have entered. When you are ready to pay click on the "Pay Now" button to be taken to the PayPal screen where you have a choice to use your PayPal account or select to pay by Credit card without creating a PayPal account.</p> 
